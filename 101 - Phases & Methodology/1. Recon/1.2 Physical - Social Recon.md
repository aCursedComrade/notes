...
You can try running usernames on search engines/social media, extract possible usernames from emails, trying to log into accounts with emails for validation, etc. Various open source databases can be used for the same purpose as well, including [data breaches](1.1%20Web%20-%20Host%20Recon.md).
