...
![](Resources/Private%20IP%20classes.png)

Sub-divisions of the same IP network can exist which are known as [Subnets](2.%20Subnet), this is usually done to group devices connected to a network for ease of identification.
