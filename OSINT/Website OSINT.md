...
- Search all the possible devices connected to the internet. Is a powerful tool to search for vulnerable access points.

### [Wayback Machine](https://web.archive.org/)
- Search for previous (cached) versions of websites.
