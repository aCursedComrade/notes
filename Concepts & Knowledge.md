...
- [Subnets and Subnetting](https://en.wikipedia.org/wiki/Subnetwork)
		...
		- [Quick Subnetting Guide](http://www.youtube.com/watch?v=ZxAwQB8TZsM)
- [MAC Adress](https://en.wikipedia.org/wiki/MAC_address)
- [TCP, UDP and the 3-Way Handshake](https://learncisco.net/courses/icnd-1/building-a-network/tcpip-transport-layer.html)
...
Visit [Goalkicker](https://goalkicker.com/) to read about Bash and Python (and more languages) in depth.
