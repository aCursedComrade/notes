...
### Blind SQLi - Authentication Bypass scenario
**Blind SQLi**
...
Level Two of the SQL Injection examples shows this exact example. We can see in the box labeled "SQL Query" that the query to the database is the following:
...
### Blind SQLi - Boolean Based scenario
**Boolean Based**
